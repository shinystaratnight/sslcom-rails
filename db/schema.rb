...
ActiveRecord::Schema.define(version: 20191017161630) do
  ...
  add_index "signed_certificates", ["url", "body", "ext_customer_ref", "ejbca_username"], name: "index_signed_certificates_u_b_ecr_eu", type: :fulltext
