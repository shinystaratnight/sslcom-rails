...
describe CdnsController do
  describe 'create' do
    ...
    let(:params) {  {api_key: Rails.application.secrets.cdnify_admin_user_api_key,
  ...
  describe 'update_resource' do
    let(:params) {  {id: '98b3515', api_key: Rails.application.secrets.cdnify_admin_user_api_key,
              resource_name: 'somewebsite', resource_origin: 'http://www.somewebsite.com' } }
    let(:invalid_params) {  {id: 'non_existent', api_key: Rails.application.secrets.cdnify_admin_user_api_key,
              resource_name: 'somewebsite', resource_origin: 'http://www.somewebsite.com' } }
