...
#       assert_match @nonwildcard_csr.strip.gsub("\n", "\r\n"), cc.signing_request
#       assert_match 'qlikdev.ezops.com', cc.certificate_names.first.name
...
#       page.must_have_content(cc.csr.common_name) # domain name
#   end
# end
