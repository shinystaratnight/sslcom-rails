...
class CertCreateWithCsrTest < ActionDispatch::IntegrationTest
  describe 'create_v1_4' do
    ...
    # includes params:
    #   4 valid contacts
    #   2 domains in addition to csr domain
    #   valid registrant
    #   non-wildcard csr
    it 'status 200' do
      ...
      assert_equal %w{qlikdev.ezops.com mail.ssltestdomain1.com www.ssltestdomain2.com}.sort, CertificateName.pluck(:name).sort
