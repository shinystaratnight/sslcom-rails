...
describe User do
  ...
  #   before(:all) do
  #     owner.ssl_account      = create(:user, :owner).ssl_account
  ...
  #
  #     approve_user_for_account(owner.ssl_account, @invited_user)
  ...
  #     @invited_user.update_attributes(default_ssl_account: owner.ssl_account.id, main_ssl_account: @main_ssl.id)
  #     @invited_user.ssl_account_users.where(ssl_account_id: owner.ssl_account.id).first.update(approved: false)
  #
  #     assert_equal 3, @invited_user.ssl_accounts.count
  ...
  describe 'role helper methods' do
    ...
    let!(:reseller_role) { Role.get_reseller_id }
    let!(:billing_role) { Role.get_billing_id }
    # before(:each) do
    #   owner.ssl_account = owner.ssl_account
    # end

    # it '#set_roles_for_account it { should set roles' do
    ...
    it '#set_roles_for_account it should ignore duplicate roles' do
      prev_roles = owner.roles.count
      owner.set_roles_for_account(owner.ssl_account, [owner_role])

      owner.roles.count.should eq prev_roles
    end

    # it '#roles_for_account it should return array of role ids' do
    #   owner.set_roles_for_account(owner.ssl_account, [reseller_role, billing_role])
    #
    ...
    # it '#update_account_role it should update assignment' do
    ...
    # it '#assign_roles it should add new roles' do
    #   assert_equal 1, owner.roles.count
    ...
    # it '#assign_roles it should ignore duplicate roles' do
    #   assert_equal 1, owner.roles.count
    #   owner.assign_roles( user: {
    #     ssl_account_id: owner.ssl_account.id,
    #     role_ids:       [owner_role] }
    ...
    # it '#remove_roles it should destroy all roles not passed in role_ids' do
    ...
    # it '#roles_list_for_user it should return scoped list for non admin' do
    ...
    #   roles = [reseller_role, billing_role]
    #   assert_equal [[owner.ssl_account.id, [owner_role]]].to_h, User.get_user_accounts_roles(owner)
    #
    #   owner.set_roles_for_account(owner.ssl_account, roles)
    #   roles << owner_role
    #   assert_equal [[owner.ssl_account.id, roles.sort]].to_h, User.get_user_accounts_roles(owner)
    # end

    # it '#get_user_accounts_roles_names it should return a mapped hash' do
    ...
    #
    #   owner.set_roles_for_account(owner.ssl_account, [reseller_role, billing_role])
    #   assert_equal [[owner.ssl_account.get_team_name, ['owner', 'reseller', 'billing']]].to_h, User.get_user_accounts_roles_names(owner)
    # end

    # it '#role_symbols it should return [scoped role_symbols] for non-admin' do
    ...
    # it '#role_symbols it should return [scoped role_symbols] for sysadmin' do
    ...
    # end
    #
    # it '#role_symbols it should return [scoped role_symbols] for super_user' do
  ...
  describe 'user invite helpers' do
    describe '#invite_new_user' do
      # it 'it should create new user and ssl_account (pre-approved)' do
    ...
    #   it 'it should NOT create user or ssl_account, it should generate invite token' do
    #     invite_user   = create(:user, :owner)
    ...
    describe 'team helpers' do
      ...
      # end
      # it '#total_teams_owned it should return owned ssl accounts/teams' do
      ...
      # end
      # it '#total_teams_can_manage_users it should return correct ssl accounts/teams' do
