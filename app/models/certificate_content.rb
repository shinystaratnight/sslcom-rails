  ...
  def domain_validation(domain)
    ...
    if CertificateContent.is_ip_address?(domain) && false # CertificateContent.is_intranet?(domain)
      ...
      if is_server
        ...
        elsif (certificate_order.certificate.is_dv? || certificate_order.certificate.is_ev? || certificate_order.certificate.is_high_assurance?) && CertificateContent.is_ip_address?(domain)
