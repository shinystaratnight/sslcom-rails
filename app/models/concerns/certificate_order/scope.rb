  ...
  module CertificateOrder
    module Scope
      ...
      included do
        ...
        scope :not_test, ->{ where(is_test: [false, nil]) }
        ...
        scope :is_new, -> { with_new_state.uniq }
        ...
        scope :falsely_expired, -> { unscoped.with_paid_state.expired.where{ external_order_number != nil }}
