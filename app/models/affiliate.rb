...
#  checks_payable_to   :string(255)
#  city                :string(255)
#  contact_email       :string(255)
#  contact_phone       :string(255)
#  country             :string(255)
#  email               :string(255)
#  epassporte_account  :string(255)
#  first_name          :string(255)
#  last_name           :string(255)
#  organization        :string(255)
#  payout_frequency    :string(255)
#  payout_method       :string(255)
#  payout_threshold    :string(255)
...
# Indexes
#
#  index_affiliates_on_ssl_account_id  (ssl_account_id)
#
