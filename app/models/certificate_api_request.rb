# == Schema Information
#
# Table name: certificate_api_requests
#
#  id                                :integer          not null, primary key
#  account_key                       :string(255)
#  assumed_name                      :string(255)
#  business_category                 :string(255)
#  common_names_flag                 :string(255)
#  company_number                    :string(255)
#  contact_email_address             :string(255)
#  csr                               :text(65535)
#  dcv_email_address                 :string(255)
#  duns_number                       :string(255)
#  email_address                     :string(255)
#  external_order_number             :string(255)
#  external_order_number_constraint  :string(255)
#  hide_certificate_reference        :boolean
#  incorporation_date                :date
#  is_customer_validated             :boolean
#  locality_name                     :string(255)
#  organization_name                 :string(255)
#  other_domains                     :string(255)
#  period                            :integer
#  post_office_box                   :string(255)
#  postal_code                       :string(255)
#  product                           :string(255)
#  registered_country_name           :string(255)
#  registered_locality_name          :string(255)
#  registered_state_or_province_name :string(255)
#  response                          :string(255)
#  secret_key                        :string(255)
#  server_count                      :integer
#  state_or_province_name            :string(255)
#  street_address_1                  :string(255)
#  street_address_2                  :string(255)
#  street_address_3                  :string(255)
#  test                              :boolean
#  created_at                        :datetime
#  updated_at                        :datetime
#  ca_certificate_id                 :string(255)
#  country_id                        :integer
