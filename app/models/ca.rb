class Ca < ActiveRecord::Base
  ...
  SSL_ACCOUNT_MAPPING = {"a30-1e3mjj3" =>
                        ...
                        "aef-1epq21m" => # SafeToOpen
                          {"SSLcom-SubCA-SSL-RSA-4096-R1" => "SafeToOpen-SSL-RSA-4096-R1",
                          # "SSLcom-SubCA-SSL-ECC-384-R2" => "SafeToOpen-SSL-ECC-384-R1",
                          "SSLcom-SubCA-CodeSigning-RSA-4096-R1" => "SafeToOpen-codeSigning-RSA-4096-R1",
                          "SSLcom-SubCA-clientCert-RSA-4096-R2" => "SafeToOpen-clientCert-RSA-4096-R1",
                          # "SSLcom-SubCA-clientCert-ECC-384-R2" => "SafeToOpen-clientCert-ECC-384-R1",
                          "SSLcom-SubCA-EV-SSL-RSA-4096-R3" => "SafeToOpen-EV-SSL-RSA-4096-R1"},
