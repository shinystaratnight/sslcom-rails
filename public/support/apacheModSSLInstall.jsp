                      ...
                      <tr>
                        <td>
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">Installing
                            your Certificate on Apache Mod_SSL</font></p>
                          ...
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">You
                            ...
                            two other certificates, named GTECyberTrustRootCA.crt
                          ...
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">1. 
                            Copy this <span class="hyperlink"><a href="cacerts/ca_new.txt" target="_blank">ca-bundle</a></span> 
                            file to the same directory as httpd.conf (this contains 
                            all of the CA certificates in the chain).</font></p>
                          ...
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff"><br>
                            Save your httpd.conf file and restart Apache.<br>
                            </font></p>
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff"><br>
                            </font></p>
                        </td>
