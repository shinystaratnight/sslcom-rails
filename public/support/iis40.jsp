                      ...
                      <tr> 
                        <td> <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff"><b>Installing 
                          ...
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff"><br>
                            <b>Step 2: Intstalling the Root &amp; Intermediate 
                          ...
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">ServicePack 
                            3:<br>
                            Install the above certificates in your Internet Explorer 
                            by opening each certificate and clicking &quot;Install 
                            Certificate&quot;. You may then use this IISCA batch 
                            file to transfer all root certificates from your Internet 
                            Explorer to the IIS (see Microsoft KnowledgeBase Q216339).</font></p>
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">ServicePack 
                            4: <br>
                            Install the above certificates manually in a specicfic 
                            root store (you may also want to read (see Microsoft 
                            KnowledgeBase Q194788):</font></p>
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">Install 
                            the GTECyberTrustGlobalRootCA.crt certificate by double 
                            clicking on the corresponding file this will start 
                            an installation wizard <br>
                            select Place all certificates in the following store 
                            and click browse <br>
                            select Show physical stores <br>
                            select Trusted Root Certification Authorities <br>
                            select Local Computer, click OK <br>
                            back in the wizard, click Next, click Finish <br>
                            Repeat the same for the ComodoClass3SecurityServicesCA.crt, 
                            however choose to place the certificates in the Intermediate 
                            Certification Authorities store.</font></p>
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">ServicePack 
                            5:<br>
                            Same as SP4.</font></p>
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">ServicePack 
