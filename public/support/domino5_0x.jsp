                    ...
                    <table width="95%" border="0" cellpadding="4" align="center">
                      <tr> 
                        <td> <font size="1"><b>Generating a Certificate Signing 
                          ...
                          Lotus Domino Server versions 5.0x </b></font> 
                          <ul>
                            <li><font size="1">Launch the <b>Domino Administration</b> 
                              client. </font></li>
                            <li><font size="1">Select <b>File-Open Server </b>and 
                              select the Domino server you wish to administer, 
                              Click the file tab, double click on <b>Server Certificate 
                              Administration</b> database (certsrv.nsf) </font></li>
                            <li><font size="1">From the administration panel, 
                              ...
                              on the local machine. </font></li>
                            <li><font size="1">Click <b>Create Key Ring</b>. </font></li>
                            ...
                            <li><font size="1">Enter a password for the server 
                              ...
                              field.<br>
                              Note: The password is case sensitive. If you are 
                              using the international version of Domino, only 
                              the 512 bit key size will work for you unless you 
                              have Release R5.04. </font></li>
                          ...
                          <p><font size="1"><br>
                            Note: You must select all the text in the second dialog 
                            box, including <b>Begin Certificate</b> and <b>End 
                            Certificate</b> when the <b>CSR</b> is requested.</font></p>
                          <p></p>
                          <p></p>
                          <font size="1"><br>
                          </font><font size="1"><font face="Verdana, Arial, Helvetica, sans-serif" color="c5e1ff"><br>
                          </font></font> </td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
