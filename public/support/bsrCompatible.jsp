...
<html>
<head>
<title>SSL Support - SSL is trusted by 99% of all Internet users</title>
                  ...
                  <tr>
                    <td><img src="../images/compatibility.gif" width="91" height="11" vspace="4"><br>
                      <table width="95%" border="0" cellpadding="4" align="center">
                        <tr>
                          <td>
                            <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">Browser
                              Acceptance</font></b></p>
                            <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">
                              SSL server certificates are trusted by over 99%
                              of Internet users:</font></b></p>
                            <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">Internet
                              Explorer 5.00 and above<br>
                              Netscape 4.x and above<br>
                              AOL 5 and above<br>
                              Opera 5 and above</font></b></p>
                            <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">
                              SSL</font><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="c5e1ff">
                              is inherently trusted on the following Operating
                              Systems:<br><br>
                              Windows 2000<br>
                              Windows XP<br>
                              Windows ME<br>
